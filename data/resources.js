...
const MINE_RESOURCE_DEFS = {
  ...
  glass_bowl: { key:'glass_bowl', icon:'🥣', name:'Glass Bowl', category:'tool', unlockLevel:15, vibe:'A shallow glass bowl — empty for now.' },
  glass_bowl_of_water:{ key:'glass_bowl_of_water', icon:'🥣', name:'Glass Bowl of Water', category:'consumable', unlockLevel:15, vibe:'A bowl filled with clear well water.' },
