...
const PLOT_FEATURE_TILE_UNLOCKS = [
  ...
  },
  {
    ...
    y: 5,
    typeId: 'whisper_camp',
    defaultTypeId: 'whisper_camp',
    placeOnUnlock: true,
    icon: '⛺',
    name: 'Whispering Woods Camp',
    desc: 'Claim the camp site east of your homestead — build with logs to unlock treks.',
  },
  {
    x: 7,
    y: 4,
    typeId: 'whispering_woods',
    defaultTypeId: 'whispering_woods',
    placeOnUnlock: true,
    icon: '🌲',
    name: 'Whispering Woods',
    desc: 'A mossy trail into the whispering trees — build the adjacent camp to launch treks.',
  },
  {
    x: 8,
    y: 5,
    typeId: 'coastal_docks',
    defaultTypeId: 'coastal_docks',
    placeOnUnlock: true,
    icon: '⚓',
    name: 'Coastal Docks',
    desc: 'Claim the dock site — build with logs to unlock Sunken Shallows treks.',
  },
  {
    x: 0,
    y: 5,
    typeId: 'gather_fairy_grove',
    defaultTypeId: 'gather_fairy_grove',
    placeOnUnlock: true,
    icon: '🧚',
    name: 'The Fairy Grove',
    desc: 'Earth-attuned foraging — Lv 15 Earth and Lv 20 Husbandry to claim. Lv 15 Foraging to harvest.',
  },
  {
    x: 9,
    y: 6,
    typeId: 'gather_sunken_rock_pools',
    defaultTypeId: 'gather_sunken_rock_pools',
    placeOnUnlock: true,
    icon: '🪨',
    name: 'The Sunken Rock Pools',
    desc: 'Water-attuned tidal pools — Lv 15 Water to claim. Lv 15 Foraging to harvest.',
  },
  {
    x: 8,
    y: 4,
    typeId: 'sunken_shallows',
    defaultTypeId: 'sunken_shallows',
    placeOnUnlock: true,
    icon: '🌊',
    name: 'Sunken Shallows',
    desc: 'A tidal shelf of salvage and sand — build the adjacent docks to launch treks.',
  },
];
